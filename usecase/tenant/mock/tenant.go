...
func (m *MockUseCase) CreateTenant(username, password string) (entity.ID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTenant", username, password)
	ret0, _ := ret[0].(entity.ID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUseCaseMockRecorder) CreateTenant(username, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTenant", reflect.TypeOf((*MockUseCase)(nil).CreateTenant), username, password)
}
